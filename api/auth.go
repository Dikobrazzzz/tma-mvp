...
// IssueAccessToken — создать и подписать access JWT.
// TTL берётся из ENV JWT_TTL (например "168h" или "15m"), по умолчанию 7 дней.
// Обязательно выставь JWT_SECRET.
...
func AuthRequired() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Доп.проверка exp (ParseWithClaims уже делает, оставим явно)
